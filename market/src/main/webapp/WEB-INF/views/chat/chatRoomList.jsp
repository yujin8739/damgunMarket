...
/*             margin-right: auto; */
        ...
        .main-content li p { margin: 5px 0; } /* 단락 간격 조정 */
        .main-content li strong { color: #333; }
        .main-content li a { text-decoration: none; color: #7b68ee; font-weight: 600; } /* 헤더 강조색과 통일 */
        .main-content li a:hover { text-decoration: underline; color: #5a4fcf; }
        ...
        .unread-count { color: #dc3545; font-weight: bold; margin-left: 10px; } /* 더 눈에 띄는 색상 */
...
<body>
    ...
    <div class="main-content">
        ...
        <p><a href="${pageContext.request.contextPath}/" class="home-link">홈으로</a></p>
    </div>
