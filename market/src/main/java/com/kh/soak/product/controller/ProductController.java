...
public class ProductController {
	...
	@ResponseBody
	public List<Product> loadProducts(@RequestParam int offset, @RequestParam int limit,
	...
	public String viewProduct(@RequestParam("pdNum") int pdNum, @RequestParam("userNo") int userNo, Model model)
			throws Exception {
	...
	public String insertProduct(@ModelAttribute Product product,
			...
			@RequestParam(value = "station", required = false) List<Integer> stations, HttpSession session,
	...
	public String deleteProduct(@RequestParam("pdNum") int pdNum, @RequestParam("userNo") int userNo,
			HttpSession session) {
		Member loginMember = (Member) session.getAttribute("loginUser");
		// int userNo = (int) loginMember.getUserNo();
	...
	@ResponseBody
	public List<Station> favoriteList(@RequestParam("pdNum") int pdNum, @RequestParam("userNo") int userNo) {
	...
	@ResponseBody
	public List<Object> favoriteList(@RequestParam int offset, @RequestParam int limit,
	...
	public String submitEditProduct(@ModelAttribute Product product, HttpSession session,
	...
	@ResponseBody
	public List<Object> selectMyPdList(@RequestParam int offset, @RequestParam int limit,
			@RequestParam(required = false) int userNo) {
		RowBounds rowBounds = new RowBounds(offset, limit);
	...
	@ResponseBody
	public String tradeEnroll(@RequestParam int pdNum, @RequestParam int userNo,
			@RequestParam(required = false) String enrollNo, @RequestParam(required = false) String status,
			HttpSession session) {
		...
		if (enrollNo == null || enrollNo.equals("")) {
			...
			if (status == null || status.equals("")) {
				/*
				 * 로그인한 회원 있을때는 상품에 연결된 거래 내역에서 예약중, 판매완료가 있으면 가져오고 없으면 로그인한 아이디와 일치하는 거래 신청이 있나
				 * 확인후 있으면 거래 신청 가져옴 만약 모두 없으면 판매중 반환
				 */
	...
	@ResponseBody
	public List<Product> selectHistoryList(@RequestParam int offset, @RequestParam int limit, @RequestParam int userNo,
	...
	@ResponseBody
	public List<Product> selectMyHistoryList(@RequestParam int offset, @RequestParam int limit,
			@RequestParam int userNo, @RequestParam String status) {
		RowBounds rowBounds = new RowBounds(offset, limit);
	...
	@ResponseBody
	public int selectHistoryUpdate(@RequestParam int pdNum, @RequestParam int userNo,
			@RequestParam(required = false) String enrollNo, @RequestParam String status) {
